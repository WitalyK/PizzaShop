class AddProducts < ActiveRecord::Migration[5.2]
  def change
  	...
  	Product.create :title => 'Vegetarian', :description => 'This is Vegetarian pizza', :price => 350, :size => 30, :is_spicy => false, :is_veg => false, :is_best_offer => false, :path_to_image => '/images/vegetarian.jpg'
  end
end
